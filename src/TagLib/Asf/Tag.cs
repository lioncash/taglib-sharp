...
namespace TagLib.Asf
{
	...
	public class Tag : TagLib.Tag, IEnumerable<ContentDescriptor>
	{
		...
		{
			get { return GetDescriptorString ("WM/AlbumSortOrder"); }
		...
		public override string[] Genres
		{
			...
			set { SetDescriptorString(String.Join("; ", value), "WM/Genre", "Genre", "WM/GenreID"); }
		}
		...
		public override uint DiscCount
		{
			get
			{
				...
				return uint.TryParse(texts[1], NumberStyles.Integer, CultureInfo.InvariantCulture, out value)
					? value
					: 0;
			}
